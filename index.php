           ...
           <?php if(isset($_GET['info'])){?>
            ...
            <div class="col-lg-12">
                ...
                <div class="mb-5 mb-lg-0 text-center text-lg-start">
                    <h1 class="display-1 lh-1 mb-3"><?=$my_setting['heading'] ?? null?></h1>
                    <p class="lead fw-normal text-muted mb-5"><?=$my_setting['description'] ?? null?></p>
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <a class="me-lg-3 mb-4 mb-lg-0" href="apply.php">
                            <button class="btn btn-primary px-4 py-2">Apply Now</button>
                        </a>
                    </div>
                </div>
            </div>
